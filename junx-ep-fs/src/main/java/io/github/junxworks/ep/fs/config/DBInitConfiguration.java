...
public class DBInitConfiguration extends TableInitComponent {

	/** 常量 tables. */
	public static final List<String> tables = Lists.newArrayList("s_file", "s_file_thumb");

	/** 常量 INIT_PATH. */
	private static final String INIT_PATH = "/io/github/junxworks/ep/fs/init";
	 ...
	 */
	@Bean(name = "EPFSDBInit", initMethod = "initialize", destroyMethod = "destroy")
