        ...
        $.get(appendCtx('/ep/sys/orgs'), function (res) {
                ...
                cols:  [
					...
					{title: '操作',align: 'center',width: '150px',template: function(d){
							return '<button class="layui-btn layui-btn-xs" onclick="edit('+d.id+')"><i class="fa fa-edit"></i>修改 </button><button class="layui-btn layui-btn-xs layui-btn-danger" onclick="deleteFunc('+d.id+')"><i class="fa fa-remove"></i>删除 </button>';
						}
					}
				],
                end: function(e){
