...
@Table(tableName="ep_s_menu",tableComment="")
public class EpSMenu {
    ...
    @Column(name="parent_id", type="BIGINT", length="19", nullable="true", comment="上级菜单编号")
    ...
    @Column(name="mark", type="VARCHAR", length="100", nullable="true", comment="菜单标记")
    private String mark;	
    
    @Column(name="url", type="VARCHAR", length="500", nullable="true", comment="菜单链接")
    private String url;	
