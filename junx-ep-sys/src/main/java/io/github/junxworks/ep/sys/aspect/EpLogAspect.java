...
public class EpLogAspect {
	...
	/** 常量 THREAD_PREFIX. */
	private static final String THREAD_PREFIX = "ep-log-";
	 ...
	 * 注解切面
	 */
	@Pointcut("@annotation(io.github.junxworks.ep.sys.annotations.EpLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		final EpSLog log = new EpSLog();
		EpLog syslog = method.getAnnotation(EpLog.class);
		if (syslog != null) {
			//注解上的描述
