...
layui.use(['table', 'form', 'xmSelect'], function() {
	...
	tableIns = table.render({
		...
		, cols: [[ //表头
			...
			, { field: 'orgName', title: '所属组织', align: 'center', width: 180 }
			, { field: 'mobile', title: '手机号', align: 'center', align: 'center', width: 140 }
			, { field: 'email', title: '邮箱', align: 'left', width: 300 }
			, { field: 'roleName', title: '角色', align: 'left', width: 200 }
			, { title: '锁定', width: 110, align: 'center', templet: '#lockTp' }
			, { title: '状态', align: 'center', width: 100, templet: '#statusTp' }
			, { title: '操作', width: 300, templet: '#operateTp' }
		]]
		, request: {
	...
	form.on('switch(userLock)', function(data) {
