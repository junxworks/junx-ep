...
var ctx = {
	...
	rootPath : function() {
		...
		var jsPath = document.getElementsByTagName('script')[document.getElementsByTagName('script').length-1].src;
		jsPath = jsPath.substr(jsPath.indexOf("/",8));
		var index = jsPath.substr(0).indexOf("/eui");
		if(index>0){
			ectx=jsPath.substr(0, index)
		}else {
			ectx= "";
		}
