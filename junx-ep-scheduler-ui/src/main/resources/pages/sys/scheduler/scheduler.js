...
layui.use(['table','laydate','form','element'], function(){
    ...
    jobTable= ltable.render({
        ...
        cols:[[
            {field: 'id', title: '任务ID', align: 'center', width: 80, fixed: 'left'},
            {field: 'jobName', title: '任务名称',  align: 'left', width: 300, fixed: 'left'},
            {field: 'status', title: '状态', width: 100, align: 'center' , fixed: 'left',
            	templet:function(d){
                        if( d.status==0){
            ...
            {field: 'beanName', title: 'Bean名称',  align: 'left',width: 150},
            {field: 'methodName', title: '方法名', align: 'left', width: 200},
            {field: 'params', title: '执行参数',align: 'left',width: 200},
    ...
    logTable=ltable.render({
        ...
        cols:[[
            ...
            {field: 'jobName', title: '任务名称',  align: 'left',width: 300},
            ...
            {field: 'methodName', title: '方法名', align: 'left', width: 200},
            {field: 'params', title: '执行参数',align: 'left',width: 200},
            {field: 'costs', title: '耗时(毫秒)', align: 'center',width: 120},
