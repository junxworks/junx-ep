...
public class SMenu {
    ...
    @Column(name="parentId", type="BIGINT", length="19", nullable="true", comment="父菜单编号")
    private Long parentId;
    
    @Column(name="name", type="VARCHAR", length="255", nullable="true", comment="菜单名称")
    private String name;	
    
    @Column(name="type", type="TINYINT", length="3", nullable="true", comment="类型 menu button")
    private Byte type;	
    ...
    @Column(name="icon", type="LONGVARCHAR", length="65,535", nullable="true", comment="菜单图标")
    private String icon;	
